...
다른 참여자의 입장·퇴장 등, 서버가 클라이언트로 보내는 이벤트 메시지입니다.
...
미디어 서버에서 수신 가능한 사용자들의 영상을 알립니다.
...
해당 사용자의 영상에 대한 P2P 연결 완료를 알립니다.
...
화면 공유를 알립니다. `screenStart` 호출 시 발생합니다.
...
커스텀 메시지 수신을 알립니다. 정의되지 않은 메시지가 필요할 경우 사용할 수 있습니다.
